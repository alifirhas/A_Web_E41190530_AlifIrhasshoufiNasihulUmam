          ...
          <div class="items-center flex">
            <span
              class="w-12 h-12 text-sm text-white bg-blueGray-200 inline-flex items-center justify-center rounded-full"><img
                ...
                src="{{ asset('img/team-1-800x800.jpg') }}" /></span></div>
        </a>
        <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none">
        ...
        <li class="items-center">
          <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
            href="{{ route('landing') }}"><i class="fas fa-newspaper text-blueGray-400 mr-2 text-sm"></i>
            Landing Page</a>
        </li>
        <li class="items-center">
          <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
            href="{{ route('profile', auth()->user()) }}"><i class="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>
            Profile</a>
        </li>
        <li class="items-center">
          <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
            href="{{ route('admin.users') }}"><i class="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>
            Users</a>
        </li>
        ...
        <li class="items-center">
          <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
            href="{{ route('login') }}"><i class="fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
            Login</a>
        </li>
        @endguest
        ...
        <li class="items-center">
          <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button
              class="text-red-200 hover:text-blueGray-500 text-xs uppercase py-3 font-bold bloc"
